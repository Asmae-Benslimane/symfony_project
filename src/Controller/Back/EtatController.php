...
class EtatController extends AbstractController
{
    ...
    {
        return $this->render('etat/index.html.twig', ['etats' => $etatRepository->findAll()]);
    }
    ...
    {
        return $this->render('etat/show.html.twig', ['etat' => $etat]);
    }
    ...
    public function edit(Request $request, Etat $etat): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('etat_index', ['id' => $etat->getId()]);
        }
